...
import com.zelianko.weatherapp.presentation.extations.formattedFullDate
import com.zelianko.weatherapp.presentation.extations.formattedShortDayOfWeek
    ...
    Card(
        ...
        Column(
            ...
            GlideImage(
                ...
                model = "https:${weather.conditionUrl}",
